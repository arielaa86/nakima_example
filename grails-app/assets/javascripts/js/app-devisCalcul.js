...
function obtenirPrixMin() {
    ...
    try {
        ...
        var element = document.querySelector("label[id=resultat]");
...
function obtenirPrixProjet() {
    ...
    if(checkBoxRemise.checked === false) {
        if (remisePourcentage * 1 > 20) {
            remisePourcentage = 20;

            document.getElementById("remisePourcentage").value = 20;
        }
    }
    ...
    var annulationSuiviElement = document.getElementById("annulationSuivi");
    var annulationSuivi = annulationSuiviElement.value * 1;


    var logistiqueElement = document.getElementById("logistique");
    var logistique = (totalHT * 2.5 / 100) - annulationSuivi;
    ...
    if (annulation > 0 && annulation <= 1) {
        verification = verification + annulation;
    } else {
