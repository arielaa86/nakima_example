...
<div class="card card-default card-table m-2">
    ...
    <div class="card-body">
        ...
        <g:hasErrors bean="${this.projetCuisine}">
                ...
                <div class="alert alert-theme alert-danger alert-dismissible col-lg-6" role="alert">
                    ...
                    <div class="message">
                        ...
                        <ul class="errors" role="alert">
                            <g:eachError bean="${this.projetCuisine}" var="error">
        ...
        <g:form resource="${this.projetCuisine}" method="PUT" autocomplete="off"
                onsubmit="document.querySelector('button[id=clickclick]').disabled = true; return true;">
            <g:hiddenField name="version" value="${this.projetCuisine?.version}"/>
            <fieldset class="form">
                <g:render template="form"/>
            </fieldset>

            <g:if test="${!this.projetCuisine.isFactureClosed()}">
                <div class="row m-5 justify-content-end">
                    <button class="btn btn-space btn-success" type="submit" id="clickclick">
                        <i class="fa fa-save"></i>
                        ${message(code: 'default.button.update.label', default: 'Enregistrer')}
                    </button>
                </div>
            </g:if>
...
<asset:javascript src="projet/actions.js"/>

<script>

    setupRadioGroups();

    $('#optionMeubleAux').val($('#optionMeuble').val());
    $('#planTravailAux').val($('#planTravail').val());
    $('#poigneesModeleAux').val($('#poignees').val());
