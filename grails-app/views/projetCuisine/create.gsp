    ...
    <body>
      <div class="card card-default card-table m-2">
        ...
        <div class="card-body">
            ...
            <g:form resource="${this.projetCuisine}" method="POST" autocomplete="off" onsubmit="document.querySelector('button[id=clickclick]').disabled = true; return true;">
                <fieldset class="form">
