...
<html>
    <head>
        ...
        <title><g:message code="default.edit.label" args="['bon de commande']" /></title>
    ...
    <div class="card card-default card-table m-2">
            ...
            <div class="row" style="color: rgba(0,0,0,0.7); vertical-align: middle">
                <div class="col-lg-12" style="font-size: 22px;">
                    ...
                    <g:if test="${this.factureClient.devis.projet.instanceOf(ProjetComplementaire)}">
                        Modifier bon de commande complémentaire
                    </g:if>
                    <g:else>
        ...
        <div class="card-body">
            ...
            <g:form resource="${this.factureClient}" method="PUT" enctype="multipart/form-data" autocomplete="off" onsubmit="submit.disabled = true; return true;">
