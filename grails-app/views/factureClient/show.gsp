...
<div class="card card-default card-table m-2">
    ...
    <div class="card-body" id="cardBody">
            ...
            <div class="card col-lg-6" id="card1" style="text-align: center">
                ...
                <g:if test="${user.authorities.contains(Role.findByAuthority("ROLE_DIRECTEUR"))}">
                    ...
                    <div style="text-align: center" id="signaturesViewDirecteur">
                        ...
                        <g:else>
                            <g:if test="${this.factureClient.signePar.signature && this.factureClient.signatureClient}">
        ...
        <div class="print">
            <g:render template="/devis/conditions" model="[factureClient: factureClient]"/>
        </div>
        ...
        <div class="row m-5 justify-content-end noPrint">
            ...
            <div id="buttonImprimer">
                ...
                <g:if test="${this.factureClient.signatureClient}">
                    ...
                    <g:link class="btn btn-space btn-outline-secondary" controller="projet" action="show" id="${this.factureClient.devis.projet.id}">
                    ...
                    <g:link class="btn btn-space btn-outline-secondary" action="dechargeResponsabilite" id="${this.factureClient.id}">
                        <i class="fa fa-ban"></i>
