...
<div class="row big">
    Bonjour, MCCorlet Agencement vous informe que votre facture acquittée est disponible.
    <br>
    <br>
    Pour la consulter, veuillez cliquer sur le bouton ci-dessous
</div>
<hr>
...
<div class="row">
    ...
    <g:if env="development">
            ...
            <a href="http://localhost:8080/factureClient/showFactureAcquittee?codeEmail=${devis.codeEmail}" class="btn">Consulter la facture</a>

    </g:if>
    <g:else>

            <a href="https://mccorlet.com/factureClient/showFactureAcquittee?codeEmail=${devis.codeEmail}" class="btn">Consulter la facture</a>
