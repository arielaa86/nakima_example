...
<table class="table table-bordered col-lg-8">
    ...
    <tr id="soldeProjetRow">
        ...
        <tr style="background-color: orange; ${this.factureClient.devis.montant > 0 ? 'visibility: visible' :  'visibility: hidden; height: 0px;'}" >
            <td colspan="2"
        ...
        <tr style="${this.factureClient.devis.montant > 0 ? 'visibility: visible' :  'visibility: hidden; height: 0px!important;'}">
...
<g:hiddenField  id="annulationSolde" name="annulationSolde" value="${this.factureClient?.devis.annulation}"/>
<g:hiddenField id="annulationVerif" name="annulationVerif" value="${this.factureClient?.devis.annulation}"/>
