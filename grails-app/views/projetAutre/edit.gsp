...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'projetAutre.label', default: 'ProjetSalleBain')}" />
        ...
        <div class="card card-header">
            <div class="row" style="color: rgba(0,0,0,0.7); vertical-align: middle">
                <div class="col-lg-12" style="font-size: 22px;">
                    Modifier projet ${this.projetAutre.typeProjet}
                </div>
            </div>
    ...
    <div class="card-body">
        ...
        <g:hasErrors bean="${this.projetAutre}">
                ...
                <div class="alert alert-theme alert-danger alert-dismissible col-lg-6" role="alert">
                    ...
                    <div class="message">
                        ...
                        <ul class="errors" role="alert">
                            <g:eachError bean="${this.projetAutre}" var="error">
        ...
        <g:form resource="${this.projetAutre}" method="PUT" autocomplete="off" onsubmit="document.querySelector('button[id=clickclick]').disabled = true; return true;">
            <g:hiddenField name="version" value="${this.projetAutre?.version}" />
            <fieldset class="form">
                <g:render template="form"/>
            </fieldset>
            <g:if test="${!this.projetAutre.isFactureClosed()}">
