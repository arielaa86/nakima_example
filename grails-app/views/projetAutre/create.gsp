...
<body>
    ...
    <div class="card-body">
        ...
        <g:form resource="${this.projetAutre}" method="POST" autocomplete="off" onsubmit="document.querySelector('button[id=clickclick]').disabled = true; return true;">
            <fieldset class="form">
