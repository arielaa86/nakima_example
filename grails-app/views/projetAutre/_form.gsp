            ...
            <div class="card card-default">
              <div class="card-body pl-sm-5">
                  ...
                  <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right">Type de projet</label>
                      <div class="col-12 col-sm-8 col-lg-2">
                          <input class="form-control" type="text" name="typeProjet"
                                 value="${this.projetAutre?.typeProjet}" />
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div id="devisOui" class="col-12 col-sm-8 col-lg-6" style="display:block">
                      <input class="form-control" type="text" name="devisOui" value="${this.projetAutre?.devisOui}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-2">
                        <g:select class="form-control custom-select" name="typeHabitation"
                                  from="${this.projetAutre?.constrainedProperties.typeHabitation.inList}"
                                  required=""
                                  value="${this.projetAutre?.typeHabitation}" onchange="showQuantiteHabitation()" />
                    </div>
                      ...
                      <div id="quantiteHabitation" class="col-12 col-sm-8 col-lg-2" style="display:none">
                          <input class="form-control" type="number" min="1" name="quantiteHabitation" value="${this.projetAutre?.quantiteHabitation}">
                      </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-2">
                        <g:select class="form-control custom-select" name="typeTravail"
                                  from="${this.projetAutre?.constrainedProperties.typeTravail.inList}"
                                  required=""
                                  value="${this.projetAutre?.typeTravail}" />
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-2">
                        <g:select required="" id="budget" class="form-control custom-select" name="budget"
                                  onchange="showBudgetAutre()" noSelection="${['':'------']}"
                                  from="${this.projetAutre.constrainedProperties.budget.inList}"
                                  value="${this.projetAutre?.budget}" />
                    ...
                    <div id="budgetAutre" class="col-12 col-sm-8 col-lg-2" style="display:none">
                      <input class="form-control" type="text" name="budgetAutre" value="${this.projetAutre?.budgetAutre}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-2">
                        <g:select id="financement" class="form-control custom-select" name="financement" onchange="showFinancementAutre()"
                                  from="${this.projetAutre.constrainedProperties.financement.inList}"
                                  required=""
                                  value="${this.projetAutre?.financement}" />
                    </div>
                    ...
                    <div id="financementAutre" class="col-12 col-sm-8 col-lg-2" style="display:none">
                      <input class="form-control" type="text" name="financementAutre" value="${this.projetAutre?.financementAutre}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-sm-8 col-lg-2">
                        <g:select class="form-control custom-select" name="style"
                                  from="${this.projetAutre.constrainedProperties.style.inList}"
                                  required=""
                                  value="${this.projetAutre?.style}" />
                    </div>
                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-3 col-lg-2">
                                        ...
                                        <g:select id="facadeLaquee" class="form-control custom-select" name="facadeLaquee"
                                                  from="${this.projetAutre.constrainedProperties.facadeLaquee.inList}"
                                                  required=""
                                                  value="${this.projetAutre?.facadeLaquee}"
                                ...
                                <div id="facadeLaqueeCouleur" class="col-12 col-sm-3 col-lg-5">
                                  <input class="form-control" type="text" name="facadeLaqueeCouleur" value="${this.projetAutre?.facadeLaqueeCouleur}">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-3 col-lg-2">
                                    <g:select id="facadeBois" class="form-control custom-select" name="facadeBois"
                                              from="${this.projetAutre.constrainedProperties.facadeBois.inList}"
                                              required=""
                                              value="${this.projetAutre?.facadeBois}"
                                ...
                                <div id="facadeBoisCouleur" class="col-12 col-sm-3 col-lg-5">
                                  <input class="form-control" type="text" name="facadeBoisCouleur" value="${this.projetAutre?.facadeBoisCouleur}">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div id="poigneesModele" class="col-12 col-sm-3 col-lg-2" style="display:block">
                                    <g:select id="poignees" class="form-control custom-select" name="poigneesModele"  onchange="showPoigneesAutre()"
                                              from="${this.projetAutre.constrainedProperties.poigneesModele.inList}"
                                              required=""
                                              value="${this.projetAutre?.poigneesModele}" />

                                </div>

                                  <label id="labelPoigneesAutre" class="col-12 col-sm-3 col-lg-1 col-form-label text-sm-right"
                                      <g:if test="${this.projetAutre?.poigneesModele.equals("Autre")}">
                                          style="display:block"
                                      </g:if>
                                      <g:else>
                                          style="display:none"
                                  ...
                                  >
                                      <input class="form-control" type="text" name="poigneesAutre" value="${this.projetAutre?.poigneesAutre}">
                                  </div>
                              </div>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-12 col-sm-8 col-lg-2">
                                      <g:select class="form-control custom-select" name="optionMeuble"
                                                from="${this.projetAutre?.constrainedProperties.optionMeuble.inList}"
                                                required=""
                                                value="${this.projetAutre?.optionMeuble}" />
                                  </div>
                              </div>

                              <g:hiddenField name="client.id" value="${this.projetAutre?.client.id}" />
