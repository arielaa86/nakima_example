...
<div class="card card-default card-table m-2">
    <div class="card-body pt-4 pb-4">
        ...
        <g:if test="${this.devis.debloquerRemise && !user.authorities.contains(Role.findByAuthority("ROLE_DIRECTEUR")) && !this.devis.decline}">
            <div class="row justify-content-center noPrint">
                <div class="alert alert-theme alert-success alert-dismissible col-lg-6" role="alert">
                    <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="s7-close"
                                                                                                      aria-hidden="true"></span>
                    </button>
                    ...
                    <div class="row ml-3 mt-3">
                        ...
                        <strong style="font-size:14px">Important !</strong>
                    </div>

                    <div class="message">
                        <ul class="errors" role="alert">
                            <li>
                                Le plafond de remise a exceptionnellement été débloqué. Vous pouvez modifier le devis et le renvoyer pour validation.
                            </li>
        ...
        <g:if test="${user.authorities.contains(Role.findByAuthority("ROLE_DIRECTEUR")) && devis.montant > 0}">
            ...
            <g:if test="${!this.devis.projet.instanceOf(ProjetComplementaire)}">
                ...
                <g:if test="${devis?.categoriePrix}">
                    <div class="row noPrint justify-content-center">
                        <div class="col-12 col-sm-8 col-lg-8 m-3">
                            <table class="table table-bordered">
                                <tbody>
                                <tr style="background-color: #e8e0da">
                                    <td class="font-weight-bold" style="font-size: 20px">Catégorie de prix</td>
                                    <td class="number font-weight-bold"
                                        style="font-size: 20px">${devis.categoriePrix}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="row ml-2 mt-6 noPrint justify-content-end"
             style="${!user.authorities.contains(Role.findByAuthority("ROLE_DIRECTEUR")) ? 'visibility: hidden' : ''}">
            <div class="form-group col-lg-12 mb-0" style="font-size: 16px">

                <label class="custom-control custom-checkbox custom-control-inline">
                    <input id="debloquerRemise" class="custom-control-input"
                           type="checkbox" ${this.devis.debloquerRemise ? 'checked=""' : ''}
                           name="debloquerRemise"
                           onclick="debloquerRemise()">
                    <span class="custom-control-label">Débloquer le plafond de la remise</span>
                </label>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <g:link class="dropdown-item"
                                        action="${devis.projet.instanceOf(ProjetComplementaire) ? 'recommencerComplement' : 'edit'}"
                                        controller="devis"
