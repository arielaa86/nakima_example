...
<div class="card card-default card-table m-2">
    ...
    <div class="card-body">
        ...
        <g:form resource="${this.projetDressing}" method="PUT" autocomplete="off"
                onsubmit="document.querySelector('button[id=clickclick]').disabled = true; return true;">
            <g:hiddenField name="version" value="${this.projetDressing?.version}"/>
            <fieldset class="form">
                <g:render template="form"/>
            </fieldset>
            <g:if test="${!this.projetDressing.isFactureClosed()}">
