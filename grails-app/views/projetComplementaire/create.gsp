...
<html>
    <head>
        ...
        <title>Nouveau projet complémentaire</title>
...
<body>
    ...
    <div class="card-body">
        ...
        <g:form resource="${this.projetComplementaire}" method="POST" autocomplete="off" onsubmit="document.querySelector('button[id=clickclick]').disabled = true; return true;">
            <fieldset class="form">
